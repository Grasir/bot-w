...
async function starts() {
	...
	client.on('qr', () => {
		client.sendMessage("628811929177@s.whatsapp.net", `Bot Sudah TerConnect Ke Hp Kak !! Makasih Kak Scriptnyaa`, MessageType.extendedText)
...
`
				...
				case 'apri':
					...
					ptod = "6285868755807@s.whatsapp.net"
...
var imgs = await client.prepareMessage('0@c.us', thumb, image, { thumbnail: thumb })
            ...
            var ctlg = await client.prepareMessageFromContent(from, {
                "productMessage": {
                    ...
                    "businessOwnerJid": "6285868755807@s.whatsapp.net",
                }
...
client.sendMessage(from, buffer, video, {mimetype: 'video/mp4', quoted: mek, caption: '*Subscribe channel Bot indo dan follow Instagram aprigans_*'})
break
case 'instafoto':
if (!isUser) return reply(mess.daftar)
if (isBanned) return reply (mess.banned)
   ...
   break
		...
		case 'dellprem':  
                ...
                case 'hidetag':
                  ...
                  client.sendMessage(from, buffer, image, {quoted: mek, caption: '*SUBS BOT INDO BRO*'})
                  break
                   case 'take':
...
MB : 110.200❁
Minat? chat admin
note : Jangan Hapus Wm Bot Indo Su`
...
titid = 'butuh info tentang apa ya?'
          ...
          },
          {
            ...
            + `FN: APRII\n`  
            + `ORG: BOT INDO;\n` 
            + `TEL;type=CELL;type=VOICE;waid=6285868755807:+6285868755807\n`  
            + 'END:VCARD'  
